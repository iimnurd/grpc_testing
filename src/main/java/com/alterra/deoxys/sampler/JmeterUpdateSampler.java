...
public class JmeterUpdateSampler extends AbstractJavaSamplerClient  {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			UpdateResponse	responseRaw = this.bclient.sendUpdateRequestToService(bclient,Integer.parseInt(this.id), this.apiVersion, this.title, this.description);
